<template>
    <div id="w_main">
        <div class="main_cont" v-loading="this.$store.state.orders.loading"
            ...
            style="width: 100%;">
            <div v-for="(item,index) in this.$store.state.orders.paidList" :key="item[0].orderno">
                <p>
            ...
            <p class="nothing" v-if="this.$store.state.orders.paidList.length == 0 && !this.$store.state.orders.loading">
